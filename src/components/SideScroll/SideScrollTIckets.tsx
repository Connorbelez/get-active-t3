...
import { ArrowRightCircle as ArrowDownCircle, ArrowLeftCircle as ArrowUpCircle } from "lucide-react"
...
export default function comp({spacing, stateKey, setSelectedTicket, setSelectedTicketData, selectedTicketData, className,vertical,tickets}: compProps) {
    ...
    const overFlow = vertical ? "overflow-y-scroll snap-y" : "overflow-x-scroll space-x-4 snap-x";
