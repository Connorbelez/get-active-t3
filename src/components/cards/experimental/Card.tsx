    ...
    return (
        <Card className={"bg-background h-[400px] w-[400px] rounded-[40px]  dark:hover:shadow-lg dark:hover:shadow-violet-700/50"}>
            ...
            <div className="rounded-[40px]   dark:shadow-lg dark:hover:shadow-lg shadow-lg shadow-black/60 dark:hover:shadow-violet-600/60 dark:shadow-violet-600/40">
                <Image src={"/canadaDay.jpg"} alt="Canada Day" className="rounded-[40px] z-0 h-[250px]"/>
            ...
            <CardBody className={"grid grid-cols-3 gap-4 overflow-hidden"}>
                    ...
                    <div className={"col-start-2 col-span-2 flex flex-col items-left my-auto "}>
                        ...
                        <CardFooter className="space-x-3">
                            <Chip className="p-2" variant={"faded"} color={"warning"} startContent={
                                 ...
                                 <p className=" prose text-sm text-warning text-nowrap">Philo</p>
                            </Chip>
                            <Chip className="p-2" variant={"faded"} color={"warning"} startContent={
