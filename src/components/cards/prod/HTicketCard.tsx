...
export default function TicketCard({
  ...
  let cname : string = "box-border-none sticky top-20 my-8 flex h-[125px] w-full rounded-none bg-transparent p-0 pb-2 shadow-none outline-none data-[focus-visible=true]:z-0 data-[focus-visible=true]:outline-none"+`${_key==selectedTicket ? "ring-2 ring-violet-700" : ""}`;
  useEffect(() => {
    cname = "box-border-none sticky top-20 my-8 flex h-[125px] w-full rounded-none bg-transparent p-0 pb-2 shadow-none outline-none data-[focus-visible=true]:z-0 data-[focus-visible=true]:outline-none"+`${_key==selectedTicket ? "ring-2 ring-violet-700" : ""}`
  }, [selectedTicket])
  ...
  return (
    ...
    <div className={`w-full mx-1 p-1 rounded-lg flex ${_key == selectedTicket ? "" : ""}`}>
    ...
    <Button
      ...
      key={_key}
      onPress={handlePress}
      className={"box-border-none sticky top-20 flex h-[125px] w-full rounded-none bg-transparent p-0 pb-2 shadow-none outline-none data-[focus-visible=true]:z-0 data-[focus-visible=true]:outline-none" }>
      <Card
        style={ _key == selectedTicket ? { filter: "drop-shadow(2px 2px 2px rgb(109 40 217))" } : {}}
        radius="none"
        className="box-border-none  box-border-none hidden h-[120px] w-full rounded-none border-none bg-transparent p-0 shadow-none outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-none sm:col-span-4 sm:col-start-9 sm:grid"
      >
        <Image
